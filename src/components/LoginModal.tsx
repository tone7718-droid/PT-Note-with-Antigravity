          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input id="login-id" type="text" value={userId} onChange={(e) => { setUserId(e.target.value); setError(""); }}
                ...
                className="w-full p-4 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:ring-4 focus:ring-gray-900/30 dark:focus:ring-white/10 focus:border-gray-900 dark:focus:border-white font-medium text-lg placeholder:text-gray-400 dark:placeholder:text-gray-600 bg-white dark:bg-gray-900 dark:text-white"
                autoFocus />
            </div>
            <div>
              <label htmlFor="login-pw" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">비밀번호</label>
              <input id="login-pw" type="password" value={password} onChange={(e) => { setPassword(e.target.value); setError(""); }}
                placeholder="••••••••"
                className="w-full p-4 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:ring-4 focus:ring-gray-900/30 dark:focus:ring-white/10 focus:border-gray-900 dark:focus:border-white font-medium text-lg placeholder:text-gray-400 dark:placeholder:text-gray-600 tracking-widest bg-white dark:bg-gray-900 dark:text-white" />
            </div>
