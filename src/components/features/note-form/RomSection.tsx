            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isSelected && !isGeneratingPdf ? "bg-gray-100/50 dark:bg-gray-800 border-gray-300 dark:border-gray-600" : "bg-gray-50/50 dark:bg-gray-900/30 border-gray-100 dark:border-gray-800",
              ...
              >
                ...
                <div className="relative w-full" ref={activeId === field.id ? dropdownRef : undefined}>
                  <Controller
                    ...
                    render={({ field: inputProps }) => (
                      <Input
                        ...
                        className={cn(isSelected && !isGeneratingPdf ? "text-gray-900 dark:text-white font-bold bg-white dark:bg-gray-800" : "", "bg-gray-50/50 dark:bg-gray-900/50")}
                  ...
                  {showDropdown && (
                    <ul className="absolute top-[105%] left-0 w-full min-w-[240px] z-50 mt-1 max-h-[300px] overflow-y-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl divide-y divide-gray-50 dark:divide-gray-700 outline-none">
                      {suggestions.map((s, idx) => (
                        <li
                          key={s}
                          className={`px-4 py-3.5 cursor-pointer text-base font-medium transition-colors flex items-center justify-between ${
                            idx === highlightIdx ? "bg-gray-900 dark:bg-white dark:text-gray-900 text-white" : "hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200"
                          }`}
                ...
                <div className="flex items-center gap-3">
                  <div className="relative min-w-[140px] max-w-[160px] shrink-0">
                    ...
                    />
                    <span className={`absolute right-4 top-1/2 -translate-y-1/2 font-bold pointer-events-none select-none text-lg ${isSelected ? 'text-gray-500 dark:text-gray-400' : 'text-gray-300 dark:text-gray-600'}`}>
                      °
                    </span>
                  </div>

                  <span className={`flex-1 text-base font-bold whitespace-nowrap overflow-hidden text-ellipsis px-2 ${isSelected ? "text-slate-600 dark:text-gray-400" : "text-gray-300 dark:text-gray-600 italic"}`}>
                ...
                {!isGeneratingPdf && (
                  <button
                    ...
                    className="h-[3.5rem] w-full lg:w-12 flex items-center justify-center rounded-xl text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors border-2 border-transparent hover:border-red-200 dark:hover:border-red-900/50 bg-white dark:bg-gray-800 shadow-sm"
                  >
        ...
        {!isGeneratingPdf && (
          <div className="mt-8 flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-2 text-gray-900 dark:text-white hover:text-black dark:hover:text-gray-300 font-extrabold px-8 py-3.5 rounded-2xl hover:bg-gray-100 dark:hover:bg-gray-800 border-2 border-transparent hover:border-gray-300 dark:hover:border-gray-700 transition-all focus:ring-4 focus:ring-gray-900/20 active:scale-95 shadow-sm text-base"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
