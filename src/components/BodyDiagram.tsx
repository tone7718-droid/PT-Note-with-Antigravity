...
type ShapeType = "ellipse" | "circle" | "polygon" | "rect" | "path";
type ShapeProps = Record<string, string | number | undefined> & {
  "data-name": string;
  className?: string;
};
...
export default function BodyDiagram({ painAreas: ext, setPainAreas: setExt }: BodyDiagramProps) {
  ...
  const renderPath = (type: ShapeType, props: ShapeProps) => {
    const name = props["data-name"];
    const isDeep = props.className?.includes("muscle-deep") ?? false;
