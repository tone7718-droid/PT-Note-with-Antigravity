...
export default function BodyDiagram({ painAreas: ext, setPainAreas: setExt }: BodyDiagramProps) {
  ...
  const handlePointerOver = (e: PointerEvent<SVGElement>) => {
    ...
    // Optional: group hover logic via class mutation can be done, but keeping it simple for React
        ...
        {view === "anterior" ? (
          <svg viewBox="0 0 500 950" className="w-full h-auto mt-4 drop-shadow-sm select-none" aria-label="전면부 해부도">
            ...
            <g data-view="anterior">
              ...
              {renderPath("polygon", { points: "215,160 195,175 205,195", className: "muscle-deep", "data-name": "우측 소흉근 (심부)" })}
              {renderPath("polygon", { points: "285,160 305,175 295,195", className: "muscle-deep", "data-name": "좌측 소흉근 (심부)" })}
          ...
          <svg viewBox="0 0 500 950" className="w-full h-auto mt-4 drop-shadow-sm select-none" aria-label="후면부 해부도">
            ...
            <g data-view="posterior">
              ...
              {renderPath("polygon", { points: "205,170 210,230 200,230 195,170", "data-name": "좌측 견갑골 내측연" })}
              {renderPath("circle", { cx: 205, cy: 240, r: 10, "data-name": "좌측 견갑골 하각" })}
              {renderPath("polygon", { points: "195,165 155,170 165,185 205,180", "data-name": "좌측 극상근" })}
              {renderPath("polygon", { points: "200,180 160,190 175,230 210,230", "data-name": "좌측 극하근" })}
              {renderPath("circle", { cx: 305, cy: 165, r: 10, "data-name": "우측 견갑골 상각" })}
              {renderPath("polygon", { points: "295,170 290,230 300,230 305,170", "data-name": "우측 견갑골 내측연" })}
              {renderPath("circle", { cx: 295, cy: 240, r: 10, "data-name": "우측 견갑골 하각" })}
              {renderPath("polygon", { points: "305,165 345,170 335,185 295,180", "data-name": "우측 극상근" })}
              {renderPath("polygon", { points: "300,180 340,190 325,230 290,230", "data-name": "우측 극하근" })}
